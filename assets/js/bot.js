...
(function (global) {
  ...
  const SYSTEM =
    ...
    'סגנון: דבר/י כמו אדם אמיתי, לא כמו טופס. תמיד קודם התייחס/י למה שהלקוח כתב עכשיו — ענה/י או הגב/י אליו באופן טבעי — ורק אז המשך/י. ' +
    'אל תשאל/י שאלות רובוטיות ואל תחזור/י על שאלה שכבר נענתה; הסק/י פרטים מהקונטקסט (למשל אם הלקוח כתב "מלטז בן 3" — כבר יש לך גזע וגיל). ' +
